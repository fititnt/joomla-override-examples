...
?>
<form action="<?php echo JRoute::_('index.php?option=com_banners&view=positions'); ?>" method="post" name="adminForm" id="adminForm">
	<div class="row-fluid">
		<!-- Begin Sidebar -->
		<div id="sidebar" class="span2">
			<div class="sidebar-nav">
				...
				<div class="filter-select">
					...
					<label for="filter_position_id" class="element-invisible"><?php echo JText::_('JOPTION_SELECT_POSITION');?></label>
					<select name="filter_position_id" id="filter_position_id" class="span12 small" onchange="this.form.submit()">
						<option value=""><?php echo JText::_('JOPTION_SELECT_POSITION');?></option>
						<?php echo JHtml::_('select.options', BannersHelper::getPositionOptions(), 'value', 'text', $this->state->get('filter.position_id'));?>
					</select>
					<hr class="hr-condensed" />
		...
		<div class="span10">
			...
			<table class="table table-striped" id="articleList">
				...
				<?php foreach ($this->items as $i => $item) :
					...
					$canChange	= $user->authorise('core.edit.state',	'com_banners.position') && $canCheckin;
					?>
					<tr class="row<?php echo $i % 2; ?>" sortable-group-id="<?php echo $item->catid?>">
						...
						<td class="nowrap has-context">
							<div class="pull-left">
								...
								<?php endif; ?>
								<?php if ($canEdit) : ?>
									<a href="<?php echo JRoute::_('index.php?option=com_banners&task=position.edit&id='.(int) $item->id); ?>">
