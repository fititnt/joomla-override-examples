...
<form action="<?php echo JRoute::_('index.php?option=com_banners&layout=edit&id='.(int) $this->item->id); ?>" method="post" name="adminForm" id="banner-form" class="form-validate form-horizontal">
	<fieldset>
		<ul class="nav nav-tabs">
			...
			<li><a href="#assignment" data-toggle="tab"><?php echo JText::_('COM_BANNERS_ASSIGNAMENT_DETAILS');?></a></li>
		</ul>
		<div class="tab-content">
			<div class="tab-pane active" id="details">
				...
				<div class="control-group">
					<div class="control-label">
						<?php echo $this->form->getLabel('positionid'); ?>
					</div>
					<div class="controls">
						<?php echo $this->form->getInput('positionid'); ?>
					</div>
				</div>
				<div class="control-group">
					<div class="control-label">
			...
			<div class="tab-pane active" id="assignment">
				<?php echo $this->loadTemplate('assignament'); ?>
			</div>
		</div>
	</fieldset>
